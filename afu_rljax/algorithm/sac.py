...
from afu_rljax.network import ContinuousQFunction, StateDependentGaussianPolicy, StateDependentGaussianPolicyZero
...
class SAC(OffPolicyActorCritic):
    ...
    def _loss_critic(
        ...
        next_state: np.ndarray,
        weight: Union[np.ndarray, List[jnp.ndarray]],
        *args,
        **kwargs,
    ) -> Tuple[jnp.ndarray, jnp.ndarray]:
        ...
        target = self._calculate_target(
            params_critic_target, log_alpha, reward, done, 
