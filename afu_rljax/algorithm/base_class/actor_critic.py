...
from afu_rljax.algorithm.base_class.base_algorithm import OffPolicyAlgorithm, OnPolicyAlgorithm
from afu_rljax.util import fake_action, fake_state, load_params, save_params
